...
class Box(object):
    ...
    def append_string(self, additional_contents):
        ...
        #    and continue working on the problem.
        # --------------------------------------------------------------
        inter=self.contents + additional_contents
        self.additional_contents=''
        self.contents=''
        if len(inter)<(self.volume+1):
            self.additional_contents=''
            self.contents=inter
            return self.additional_contents
        else:
            for k in range(self.volume,len(inter)):
                self.additional_contents=self.additional_contents+inter[k]
            for kk in range(0,(self.volume)):
                self.contents=self.contents+inter[kk]
            return self.additional_contents
    def double(self):
        """
        What comes in:
        ...
        return self.append_string(self.additional_contents)
    ...
    def steal(self, other_box):
        ...
        #    ** TWO **   LINES OF CODE.
        ################################################################
        k=self.append_string(other_box.contents)
        other_box.contents=k
